...
function main() {
  ...
  modelMatrix.setRotate(0.0, 0, 0, 1);  // Set rotation matrix
  ...
  //triangle 2
  modelMatrix.setRotate(90.0, 0, 0, 1);  // Set rotation matrix
  modelMatrix.translate(0, -Tx, 0);
  gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
  gl.uniform4f(u_FragColor, Math.random(), Math.random(), Math.random(), 1);
  gl.drawArrays(gl.TRIANGLES, 0, n);
  ...
  modelMatrix.setRotate(180.0, 0, 0, 1);  // Set rotation matrix
  modelMatrix.translate(0.0, -Tx, 0);
  gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
  gl.uniform4f(u_FragColor, Math.random(), Math.random(), Math.random(), 1);
  gl.drawArrays(gl.TRIANGLES, 0, n);
  
  //fourth triangle
  modelMatrix.setRotate(270.0, 0, 0, 1);  // Set rotation matrix
  modelMatrix.translate(0.0, -Tx, 0);
  gl.uniformMatrix4fv(u_ModelMatrix, false, modelMatrix.elements);
  gl.uniform4f(u_FragColor, Math.random(), Math.random(), Math.random(), 1);
  gl.drawArrays(gl.TRIANGLES, 0, n);
